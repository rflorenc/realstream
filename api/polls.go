...
type poll struct {
	// We are using BSON to talk with Mongo
	// and JSON to talk to the client
...
func handlePollsGet(w http.ResponseWriter, r *http.Request) {
	...
	var result []*poll
	// q.All is fine for small number of polls.
	// for scale use an Iter()
...
func handlePollsPost(w http.ResponseWriter, r *http.Request) {
	...
	if err := decodeBody(r, &p); err != nil {
		respondErr(w, r, http.StatusBadRequest, "failed to insert poll", err)
		return
	}
